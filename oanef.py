...
model.compile(
    optimizer=opt, loss="categorical_crossentropy", metrics=["BinaryCrossentropy"]
)
...
print("\n\n ==========Evalutating Model========== \n")
_, acc = model.evaluate_generator(test_generator, steps=len(test_generator), verbose=3)
print("\n\nACCURACY:  %.3f \n\n" % (acc * 100.0))
